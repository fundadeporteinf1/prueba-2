<html>	
  <head><title>Varios Marcadores - Oficinas</title></head>
  <center><h1>Oficinas - Fundadeporte</h1></center>
  
<center><form method="post" action="">
    <input type="submit" name="boton_1" id="boton_1" value="Volver" dir="index.php" />
    <input type="submit" name="boton_1" id="boton_1" value="Nuevo Marcador" dir="#" />    
</form> </center>
